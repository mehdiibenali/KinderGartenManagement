...
namespace KinderGartenManagment.Api.Controllers
{
    ...
    [ApiController]
    public class EnrollementWinterClubsController : ControllerBase
    {
        private readonly IEnrollementWinterClubRepository _EnrollementRepository;
        private readonly IMapper _mapper;

        public EnrollementWinterClubsController(IEnrollementWinterClubRepository EnrollementRepository, IMapper imapper)
        {
