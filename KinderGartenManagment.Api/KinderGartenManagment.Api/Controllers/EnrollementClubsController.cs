...
namespace KinderGartenManagment.Api.Controllers
{
    ...
    [ApiController]
    public class EnrollementClubsController : ControllerBase
    {
        private readonly IEnrollementClubRepository _EnrollementRepository;
        private readonly IMapper _mapper;

        public EnrollementClubsController(IEnrollementClubRepository EnrollementRepository, IMapper imapper)
        {
