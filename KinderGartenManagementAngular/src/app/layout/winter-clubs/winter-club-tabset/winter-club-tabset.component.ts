...
@Component({
  selector: 'app-winter-club-tabset',
  templateUrl: './winter-club-tabset.component.html',
  styleUrls: ['./winter-club-tabset.component.css']
})
export class WinterClubTabsetComponent implements OnInit {
